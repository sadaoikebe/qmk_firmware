...
// NICOLA親指シフト
  // デフォルトレイヤーに関係なくQWERTYで
    [_NICOLA] = LAYOUT( \
      KC_ESC,  NG_1,    NG_2,    NG_3,    NG_4,   NG_5,     NG_6,    NG_7,   NG_8,    NG_9,    NG_0,    NG_MINS,  NG_EQL,  KC_TRNS, KC_BSPC, KC_TRNS, \
...
<<<<<<< HEAD
      KC_TRNS, KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS, KC_LEFT,  KC_DOWN, KC_UP,   KC_RIGHT, KC_INS,  KC_DEL,  KC_ENT,                   KC_TRNS, \
=======
