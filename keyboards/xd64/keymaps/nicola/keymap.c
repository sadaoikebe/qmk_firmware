...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_64_ansi_split_noarrow( \
      ...
      MO(_FUNC),   KC_LGUI, KC_LALT,                          KC_SPC,  KC_SPC,                   KC_RALT, KC_RGUI,  KC_APP,  KC_RCTL  ),
...
// NICOLA親指シフト
  ...
  // Function Layer
  [_FUNC] = LAYOUT_64_ansi_split_noarrow( \
      ...
      MO(_FUNC),   KC_NO,   KC_NO,                         KC_KANA2, KC_EISU,                   KC_NO,   KC_NO,   KC_NO,   KC_NO   )
