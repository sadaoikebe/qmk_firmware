...
// NICOLA親指シフト
  ...
  [_FUNC] = LAYOUT( \
      ...
      //KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC,  KC_TRNS,
      //KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,   KC_PSCR, KC_TRNS, KC_BRK,    KC_TRNS, KC_TRNS,
      //KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,    KC_RIGHT, KC_INS,  KC_DEL,           KC_ENT,  KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, KC_BRK, KC_INS,  KC_DEL,           KC_TRNS,  KC_TRNS,
      KC_TRNS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_F5,  KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,       KC_TRNS, KC_PGUP, \
      //KC_LSFT,          KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_MINS,  KC_EQL, KC_TRNS, KC_PGUP, KC_TRNS,
      MO(_FUNC), KC_TRNS, KC_TRNS,        KC_EISU,               KC_KANA2,       KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END )
};
